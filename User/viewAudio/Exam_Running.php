...
function get_value()
{
   ...
   header("Location: http://localhost/hse/User/viewAudio/Exam_Finish.php");
...
<script>
    ...
    location.replace("http://localhost/hse/User/viewAudio/Exam_Finish.php")
    }
</script>
<style>
...
<center>
    ...
    <tr>
        ...
        <td> <button class="btn btn-success" name="btn_finish" href="http://aa-kramah.com/hse/User/viewAudio/Exam_Finish.php" style="width:120px" >Done</button></td>
    </tr>
