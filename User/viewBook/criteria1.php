...
<div class="hs"  >
   ...
   <table>
<th rowspan="6"><center><form action="all_exam_category.php" method="post" enctype="multipart/form-data" id="importFrm" name="importFrm" onsubmit="return myFunction()" class="form">
