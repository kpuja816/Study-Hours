...
<script>
function myFunction() {
  location.replace("http://localhost/hse/User/viewBook/Exam_Running.php")
}
</script>
...
<div style="height:70%;width:100%;background-image:url(../../images/hse.jpg);background-repeat:none;background-size:100% 100% "></div>
