...
?>
<center>
<h3>You Have Successffuly finish the Exam</h3>
...
<?php
    ...
    $list = array (array($_SESSION['ClientID'],date("d-M-Y H:i:s A"),"Video",$category,$total_ques,$answered,$total_ques-$answered,$correct,$wrong,$score));
