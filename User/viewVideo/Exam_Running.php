...
function get_value()
{
   ...
   header("Location: http://localhost/hse/User/viewVideo/Exam_Finish.php");
...
<script>
    ...
    location.replace("http://localhost/hse/User/viewVideo/Exam_Finish.php")
    }
</script>
<style>
...
<center>
 ...
 <?php  
        ...
        while($result = mysqli_fetch_array($sql)) 
         ...
         ?> 
<tr><td colspan="2" ><p>Question : <?php echo $result['question']; ?></p></td></tr>
...
<center>
    ...
    <tr>
        ...
        <td> <button class="btn btn-success" name="btn_finish" href="http://aa-kramah.com/hse/User/viewVideo/Exam_Finish.php" style="width:120px" >Done</button></td>
    </tr>
