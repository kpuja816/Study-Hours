...
$system_email='';
  $system_email_query = mysqli_query($con,"SELECT * FROM user_details");
...
if (!$email) {
 ...
 <?php
   ...
   $sel_query = "SELECT * FROM user_details WHERE email='".$email."'";
...
http://localhost//hse/User/login/reset_password.php?key=$key&email=$email&action=reset <br><br>
...
<script>
function myFunction() {
  location.replace("http://localhost/hse/User/login/user_login.php")
}
