...
if(isset($_POST['btn-upload']))
{
 ...
 $query =$_POST['query'];
  header("Location: http://localhost/hse/searchbook_1_1_1.php?query=".$query);
 ...
 <div class="navbar navbar-inverse navbar-fixed-top " id="menu">
      ...
      <!--NAVBAR SECTION END-->
        ...
        <h2 data-scroll-reveal="enter from the bottom after 0.1s" ><span class="bckleft"> <a  href="admin_ds.html" class="btn btn-primary btn-lg" > Back  </a></span>
         ...
         <span class="sendright">  <form class="search" action="criteria1.php" method="POST">
            ...
            <select name="query">
				...
				</select> 	<button  class ="btn btn-danger btn-lg" name="btn-upload">SEARCH BOOK</button>
   </th>
						&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;	<span class="sendright"> <a  href="book/addbook.php" class="btn btn-primary btn-lg" name="viewAll" > VIEW ALL </a></span>
								</form>
                      </span>
