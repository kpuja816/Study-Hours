 ...
 <div class="navbar navbar-inverse navbar-fixed-top " id="menu">
      ...
      <!--NAVBAR SECTION END-->
        ...
        <h2 data-scroll-reveal="enter from the bottom after 0.1s" ><span class="bckleft"> <a  href="admin_ds.html" class="btn btn-primary btn-lg" > Back  </a></span>
    		  ...
    		  <span class="sendright">  <form class="search" action="Video/addvideo.php" method="GET">
							<input type="text" name="query" placeholder="Search..."   style="width:120px;" required>
							<button  class ="btn btn-danger btn-lg" href="Video/addvideo.php">SEARCH VIDEO</button>
								</form>
                      </span>
		</h2> <!-- <h3></h3>-->
                   </div>
