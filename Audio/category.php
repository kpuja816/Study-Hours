...
if(isset($_POST['add']))
{
    ...
    if($add_value != "")
    {
    mysqli_query($con,"INSERT INTO category(main_category,add_value)VALUES('$main_category','$add_value')");
    }
}
...
<i class="fa fa-circle-o-notch"></i> SUB CATEGORY
 ...
 <select name ="main_category" style="width:250px">
        ...
        for($i=0;$i<count($program);$i++)
            ...
            >  <?php echo $program[$i]; ?> </option> <?php } ?>
		            ...
		            <th width="116" ><center><input type="text" name="add_value" size="24" placeholder="Add New Sub Category"></center></th>
				...
				<?php
				    ...
				    {
				        ?>
				        <option value="<?php echo $result['id']; ?> "><?php echo $result['add_value']; ?></option>
				        <?php
				    }
				?>
				</center>
