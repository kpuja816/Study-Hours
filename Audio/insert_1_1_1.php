...
{
$id = $_SESSION['id'];
$sql = mysqli_query($con,"SELECT * FROM Audio WHERE id='$id'");
...
{
?>    
        <h2 data-scroll-reveal="enter from the bottom after 0.1s" ><span class="bckleft"> <a  href="addaudio.php" class="btn btn-primary btn-lg" > Back  </a></span>
...
<i class="fa fa-circle-o-notch"></i> 1.1.1 Audio Details 
...
<tr>
  <th width="116">Audio ID</th><th>
<input type="text" name="audio_id" class="hiii" id="t0"    >
</th>   
  </tr> 
  
<tr>
 <th width="116">Audio Name</th><th>
 <input  type="text" name="audio_name"class="hiii" id="t0"  onkeyup="captitalize(this)"   >
   </th>
  </tr>
   <tr>
...
<select name="BaseCategory">
				...
				<?php
				    ...
				    {
				        ?>
				        <option><?php echo $result['bvalue']; ?></option>
				        <?php
				    }
				?>
...
<select name="sub_category">
				...
				<?php
				    ...
				    $sql = mysqli_query($con,"SELECT * FROM category where main_category='Audio'");
