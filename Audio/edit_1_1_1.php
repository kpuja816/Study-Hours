...
include('../db_configure.php');
 if(isset($_GET['id']))
  {
  $id=$_GET['id'];
  $getselect=mysqli_query($con,"SELECT * FROM Audio WHERE id=$id");
...
{    
 ...
 // $bvalue=$_POST['bvalue'];
	...
	if(true)
	{
    $sql="UPDATE Audio SET audio_id='$audio_id',audio_name='$audio_name',upload_date='$upload_date',link='$link',image='$fileNameNew',BaseCategory='$BaseCategory',sub_category='$sub_category' WHERE id='$id2'";
...
?>
      ...
      <!--NAVBAR SECTION END--><br/><br/>
        ...
        <h2 data-scroll-reveal="enter from the bottom after 0.1s" ><span class="bckleft"> <a  href="addaudio.php" class="btn btn-primary btn-lg" > Back  </a></span><i class="fa fa-circle-o-notch"></i>1.1.1 Audio Details <i class="fa fa-circle-o-notch"></i> 
...
<tr><th width="116">AUDIO ID</th><th>
<input type="text" name="audio_id" class="hiii" id="t0"  value="<?php echo $audio_id; ?>"  >

</th>
</tr>

<tr>
 <th width="116">AUDIO NAME</th><th>
 <input  type="name" name="audio_name"class="hiii" id="t0"  onkeyup="captitalize(this)"  value="<?php echo $audio_name; ?>"  >
   </th>
  </tr> <tr>
...
<select name="BaseCategory">
				...
				<?php
				    ...
				    $sql = mysqli_query($con,"SELECT bvalue FROM edit_base_category where main_category='Audio'");
...
<select name="sub_category">
				...
				<?php
				    ...
				    $sql = mysqli_query($con,"SELECT add_value FROM category where main_category='Audio'");
...
<tr>
  <th width="116">LINK OF THE AUDIO</th><th>
