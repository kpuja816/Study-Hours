...
?>
      ...
      <!--NAVBAR SECTION END--></br></br>
        ...
        <h2 data-scroll-reveal="enter from the bottom after 0.1s" ><span class="bckleft"> <a  href="addaudio.php" class="btn btn-primary btn-lg" > Back  </a></span><i class="fa fa-circle-o-notch"></i> 1.1.1 Search The Audio Details<i class="fa fa-circle-o-notch"></i>&nbsp;&nbsp;&nbsp;&nbsp; 
...
<?php
    ...
    if(strlen($query) >= $min_length){ // if query length is more or equal minimum length then
        ...
        $raw_results = mysqli_query($con,"SELECT * FROM Audio
            WHERE (`audio_id` LIKE '%".$query."%') OR 
			(`audio_name` LIKE '%".$query."%') OR 
