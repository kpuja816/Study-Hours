...
if(isset($_POST['btn-upload']))
{
 ...
 $query =$_POST['query'];
  header("Location: http://localhost/hse/searchvideo_1_1_1.php?query=".$query);
...
<body style="overflow: hidden;">
 ...
 <div class="navbar navbar-inverse navbar-fixed-top " id="menu">
      ...
      <!--NAVBAR SECTION END-->
         ...
         <span class="sendright">  <form class="search" action="criteria3.php" method="POST">
            ...
            <select name="query">
				...
				</select> 	<button  class ="btn btn-danger btn-lg" name="btn-upload">SEARCH VIDEO</button>
   </th>
						&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;	<span class="sendright"> <a  href="Video/addvideo.php" class="btn btn-primary btn-lg" > VIEW ALL </a></span>
								</form>
                      </span>
...
<div class="hs"  >
    ...
    <div class="showcase" style="width:80%;line-height: 80%;">    
		...
		<H4>&nbsp;<?php echo $result['video_name'];?></H4>
			</div>
		</div>
		 </li>
        <?php } ?>
...
<input type="hidden" style="margin-top:20px;margin-left:700px;background:white;" name="btn-upload"  href="all_exam_category.php" ></input></th>
