...
if(isset($_POST['btn-upload']))
{
 ...
 $query =$_POST['query'];
  header("Location: http://localhost/hse/searchaudio_1_1_1.php?query=".$query);
...
<body >
 ...
 <div class="navbar navbar-inverse navbar-fixed-top " id="menu">
      ...
      <!--NAVBAR SECTION END-->
        ...
        <h2 data-scroll-reveal="enter from the bottom after 0.1s" ><span class="bckleft"> <a  href="admin_ds.html" class="btn btn-primary btn-lg" > Back  </a></span>
         <span class="sendright">  <form class="search" action="criteria2.php" method="POST">
            ...
            <select name="query">
				...
				</select> 	<button  class ="btn btn-danger btn-lg" name="btn-upload">SEARCH AUDIO</button>
   </th>
						&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;	<span class="sendright"> <a  href="Audio/addaudio.php" class="btn btn-primary btn-lg" name="viewAll" > VIEW ALL </a></span>
								</form>
                      </span>
...
<div class="hs"  >
    ...
    <div class="showcase" style="width:80%;line-height: 80%;">    
		...
		<div style="width=100%;height:20%;padding-left:10px;overflow: hidden;margin-right:10px;">
