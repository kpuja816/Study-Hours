...
$query1=mysqli_query($con,"SELECT role FROM Video where id=$ss");
$rolen="";
...
?>
      ...
      <!--NAVBAR SECTION END--></br></br>
        ...
        <h2 data-scroll-reveal="enter from the bottom after 0.1s" ><span class="bckleft"> <a  href="addvideo.php" class="btn btn-primary btn-lg" > Back  </a></span><i class="fa fa-circle-o-notch"></i> 1.1.1 Search The Video Details<i class="fa fa-circle-o-notch"></i>&nbsp;&nbsp;&nbsp;&nbsp; 
...
<?php
    ...
    if(strlen($query) >= $min_length){ // if query length is more or equal minimum length then
        ...
        $raw_results = mysqli_query($con,"SELECT * FROM Video
            WHERE (`video_id` LIKE '%".$query."%') OR 
			(`video_name` LIKE '%".$query."%') OR 
				(`BaseCategory` LIKE '%".$query."%') OR
					(`sub_category` LIKE '%".$query."%') OR
			(`upload_date` LIKE '%".$query."%') OR 
		   (`link` LIKE '%".$query."%') OR 
		
			(`image` LIKE '%".$query."%')") or die(mysql_error());
   ...
   $image=$row['image'];
	         ...
	         echo'<tr>' . '<td>'.'<centre>';	
		      ...
		      echo $video_id . '</br>' . '<td>'.'<center>';
			echo $video_name. '</br>' . '<td>'.'<center>';
			...
			echo"<a href=\"edit_1_1_1.php?id=$row[id]\"><img src=\"../images/edit.png\" height=\"25\"></a>
			<td><a href=\"delete_1_1_1.php?id=$row[id]\"><img src=\"../images/delete.png\" height=\"25\" onClick=\"return confirm('Are you sure you want to delete?')\"></a></td>";
