...
{
?>    
        <h2 data-scroll-reveal="enter from the bottom after 0.1s" ><span class="bckleft"> <a  href="addvideo.php" class="btn btn-primary btn-lg" > Back  </a></span>
...
<i class="fa fa-circle-o-notch"></i> 1.1.1 Video Details 
...
<tr>
  <th width="116">Video ID</th><th>
<input type="text" name="video_id" class="hiii" id="t0"    >
</th>   
  </tr> 
  
<tr>
 <th width="116">Video Name</th><th>
 <input  type="text" name="video_name"class="hiii" id="t0"  onkeyup="captitalize(this)"   >
   </th>
  </tr>
  <tr>
...
<select name="sub_category">
				...
				<?php
				    ...
				    $sql = mysqli_query($con,"SELECT * FROM category where main_category='Video'");
