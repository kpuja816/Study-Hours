 ...
 foreach($cnt as $delid)
  {
    ...
    $cont++;
     ...
     $query= mysqli_query($con,"DELETE FROM Video WHERE id='$delid'");
...
{
?>
        <h2 data-scroll-reveal="enter from the bottom after 0.1s" ><span class="bckleft"> <a  href="../criteria3.php" class="btn btn-primary btn-lg" > Back  </a></span>
...
1.1.1 Details of Video <i class="fa fa-circle-o-notch"></i>
