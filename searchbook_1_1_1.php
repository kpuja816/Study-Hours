...
?>
      ...
      <!--NAVBAR SECTION END--></br></br>
        ...
        <h2 data-scroll-reveal="enter from the bottom after 0.1s" ><span class="bckleft"> <a  href="criteria1.php" class="btn btn-primary btn-lg" > Back  </a></span><i class="fa fa-circle-o-notch"></i> 1.1.1 Search The Books Details<i class="fa fa-circle-o-notch"></i>&nbsp;&nbsp;&nbsp;&nbsp; 
      ...
      $currency = $row['currency'];
       $author = $row['author'];
		...
		$link=$row['link'];
			...
			echo"<a href=\"book/edit_1_1_1.php?id=$row[id]\"><img src=\"images/edit.png\" height=\"25\"></a>
			<td><a href=\"book/delete_1_1_1.php?id=$row[id]\"><img src=\"images/delete.png\" height=\"25\" onClick=\"return confirm('Are you sure you want to delete?')\"></a></td>";
