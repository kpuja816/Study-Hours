...
?>
      ...
      <!--NAVBAR SECTION END--></br></br>
        ...
        <h2 data-scroll-reveal="enter from the bottom after 0.1s" ><span class="bckleft"> <a  href="criteria3.php" class="btn btn-primary btn-lg" > Back  </a></span><i class="fa fa-circle-o-notch"></i> 1.1.1 Search The Video Details<i class="fa fa-circle-o-notch"></i>&nbsp;&nbsp;&nbsp;&nbsp; 
...
<?php
   ...
   $image=$row['image'];
			...
			echo"<a href=\"Video/edit_1_1_1.php?id=$row[id]\"><img src=\"images/edit.png\" height=\"25\"></a>
			<td><a href=\"Video/delete_1_1_1.php?id=$row[id]\"><img src=\"images/delete.png\" height=\"25\" onClick=\"return confirm('Are you sure you want to delete?')\"></a></td>";
