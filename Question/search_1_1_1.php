...
?>
      ...
      <!--NAVBAR SECTION END--></br></br>
        ...
        <h2 data-scroll-reveal="enter from the bottom after 0.1s" ><span class="bckleft"> <a  href="addquestion.php" class="btn btn-primary btn-lg" > Back  </a></span><i class="fa fa-circle-o-notch"></i> 1.1.1 Search The Books Details<i class="fa fa-circle-o-notch"></i>&nbsp;&nbsp;&nbsp;&nbsp; 
...
<?php
    ...
    if(strlen($query) >= $min_length){ // if query length is more or equal minimum length then
        ...
        $raw_results = mysqli_query($con,"SELECT * FROM ques_answer
            WHERE (`category` LIKE '%".$query."%') OR (`question` LIKE '%".$query."%') OR 
			(`option1` LIKE '%".$query."%') OR 
			(`option2` LIKE '%".$query."%') OR 
		    	(`option3` LIKE '%".$query."%') OR 
			(`option4` LIKE '%".$query."%') OR 
			(`option5` LIKE '%".$query."%') OR 
			(`correct_answer` LIKE '%".$query."%')") or die(mysql_error());
