...
if(isset($_POST['add']))
{
    ...
    if($add_value != "")
    {
    mysqli_query($con,"INSERT INTO edit_currency(value)VALUES('$add_value')");
    }
}
...
if(isset($_POST['remove']))
{
    ...
    mysqli_query($con,"DELETE FROM edit_currency WHERE id='$id'");
    }
}
...
<input type="hidden" name="file-hidden" class="hiii" id="t0" value="NONE" required>
		        ...
		        <tr>
		            <th width="116" ><center><input type="text" name="value" size="24" placeholder="Add New currency"></center></th>
