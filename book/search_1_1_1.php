...
?>
      ...
      <!--NAVBAR SECTION END--></br></br>
        ...
        <h2 data-scroll-reveal="enter from the bottom after 0.1s" ><span class="bckleft"> <a  href="addbook.php" class="btn btn-primary btn-lg" > Back  </a></span><i class="fa fa-circle-o-notch"></i> 1.1.1 Search The Books Details<i class="fa fa-circle-o-notch"></i>&nbsp;&nbsp;&nbsp;&nbsp; 
...
<th><center>LINK OF THE BOOK</center></th>
...
<?php
    ...
    if(strlen($query) >= $min_length){ // if query length is more or equal minimum length then
		...
		(`link` LIKE '%".$query."%') OR
			...
			(`currency` LIKE '%".$query."%') OR
			(`author` LIKE '%".$query."%') OR
		
			(`price` LIKE '%".$query."%')") or die(mysql_error());
       ...
       $author = $row['author'];
		...
		$link=$row['link'];
	         ...
	         echo'<tr>' . '<td>'.'<centre>';	
		      ...
		      echo $book_id . '</br>' . '<td>'.'<center>';
			echo $book_name. '</br>' . '<td>'.'<center>';
			echo $upload_date . '</br>' . '<td>'.'<center>';
					echo $image . '</br>' . '<td>'.'<center>';
					echo $BaseCategory . '</br>' . '<td>'.'<center>';
					echo $sub_category . '</br>' . '<td>'.'<center>';
					echo $currency . '</br>' . '<td>'.'<center>';
					echo $author . '</br>' . '<td>'.'<center>';
					echo $price . '</br>' . '<td>'.'<center>';
