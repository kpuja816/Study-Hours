 ...
 foreach($cnt as $delid)
  {
    ...
    $cont++;
     ...
     $query= mysqli_query($con,"DELETE FROM Book WHERE id='$delid'");
...
{
?>
        <h2 data-scroll-reveal="enter from the bottom after 0.1s" ><span class="bckleft"> <a  href="../criteria1.php" class="btn btn-primary btn-lg" > Back  </a></span>
...
1.1.1 Details of Books <i class="fa fa-circle-o-notch"></i>
...
<form action="addbook.php" method="post" class="form"  name="frm">
...
<th><center>Image of the Book</center></th>
...
<button style="margin-left:30px;"  type="submit" onclick = "location.href = 'insert_1_1_1.php'" class ="btn btn-primary btn-lg" name="Create" >Create Record </button><br/>
